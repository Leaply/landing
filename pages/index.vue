...
<div>
  ...
  <div class="relative bg-white dark:bg-gray-900 overflow-hidden">
    <div class="max-w-screen-xl mx-auto">
      <div class="relative z-10 pb-8 bg-white dark:bg-gray-900 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
        <svg class="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-white dark:text-gray-900 transform translate-x-1/2" fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none">
        ...
        <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
          <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div class="flex items-center justify-between w-full md:w-auto">
                <a href="/" aria-label="Home">
                  <img class="h-8 w-auto sm:h-10" src="/img/logo.svg" alt="Leaply" />
                </a>
            ...
            <div class="hidden md:block md:ml-10 md:pr-4">
              <a href="#testimonials" class="font-medium text-gray-500 hover:text-gray-900 dark-hover:text-gray-400 transition duration-150 ease-in-out">
                Testimonials
              </a>
              <a href="#features" class="ml-8 font-medium text-gray-500 hover:text-gray-900 dark-hover:text-gray-400 transition duration-150 ease-in-out">
                Features
              </a>
              <a href="/login" class="ml-8 font-medium text-indigo-600 hover:text-indigo-900 dark-hover:text-indigo-500 transition duration-150 ease-in-out">
                Log in
              </a>
            </div>
          </nav>
        ...
        <transition
          ...
          enter-to-end="transform opacity-100 scale-100"
        ...
        >
          ...
          >
            <div class="rounded-lg shadow-md">
              <div class="rounded-lg bg-white dark:bg-gray-900 shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                ...
                <div class="px-2 pt-2 pb-3">
                  <a href="#testimonials" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">
                    Testimonials
                  </a>
                  <a href="#features" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">
                    Features
                  </a>
                </div>
                <div>
        ...
        <div class="sm:text-center lg:text-left">
          <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 dark:text-gray-300 sm:text-5xl sm:leading-none md:text-6xl">
            Find your <span class="text-indigo-600">future</span>
          </h2>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
            Looking for that perfect fit? Leaply helps you find great
            opportunities that match your interests; whether it's a job,
            sponsorship, internship or event.
          </p>
            ...
            <div class="rounded-md shadow">
              <a href="#"
                class="
                  ...
                  rounded-md
                  text-white
                  bg-indigo-600 hover:bg-indigo-500 dark-hover:bg-indigo-500
            ...
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <a href="#"
                class="
                  ...
                  rounded-md
                  text-indigo-700
                  bg-indigo-100 hover:text-indigo-600 hover:bg-indigo-50 dark-hover:bg-indigo-50
  ...
  <!-- Testimonials  -->
  <section class="py-12 bg-gray-50 dark:bg-gray-800 overflow-hidden md:py-20 lg:py-24" id="testimonials">
    <div class="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative">
        ...
        <blockquote class="mt-8">
          <div class="max-w-3xl mx-auto text-center text-2xl leading-9 font-medium text-gray-900 dark:text-gray-300">
            <p>
          ...
          <footer class="mt-8">
            <div class="md:flex md:items-center md:justify-center">
              ...
              <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                <div class="text-base leading-6 font-medium text-gray-900 dark:text-gray-100">
                  Judith Black
                </div>
  ...
  <!-- Feature Set -->
  <div class="py-12 bg-white dark:bg-gray-900" id="features">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        ...
        <p class="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
          An innovative application mechanism streamlines the process and helps
          find opportunities suitable to you.
        </p>
      </div>
  ...
  <div class="bg-gray-50 dark:bg-gray-800">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
      <h2 class="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 dark:text-gray-200 sm:text-4xl sm:leading-10">
        Ready to dive in?
        <br />
        <span class="text-indigo-600">Sign up to get started.</span>
      </h2>
  ...
  <div class="bg-gray-800 dark:bg-gray-900">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
      <div class="lg:w-0 lg:flex-1">
        ...
        <p class="mt-3 max-w-3xl text-lg leading-6 text-gray-300 dark:text-gray-500">
          Want to know how development is going or when new features are released?
        </p>
      </div>
        ...
        <form class="sm:flex" aria-labelledby="newsletter-headline">
          <input
            ...
            class="
              ...
              focus:outline-none focus:placeholder-gray-400 dark-focus:placeholder-gray-900
              transition duration-150 ease-in-out
              sm:max-w-xs
            "
          ...
          <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button
              class="
                ...
                text-white
                bg-indigo-600 hover:bg-indigo-500 dark-hover:bg-indigo-500
                hover:bg-indigo-400 dark-hover:
  ...
  <div class="bg-white dark:bg-gray-900">
    <div class="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      <nav class="-mx-5 -my-2 flex flex-wrap justify-center">
        <div class="px-5 py-2">
          <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900 dark-hover:text-gray-400">
            About
          </a>
          <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900 dark-hover:text-gray-400">
            Privacy
      ...
      <div class="mt-8 flex justify-center">
        <a href="https://facebook.com/goleaply" class="text-gray-400 hover:text-gray-500 dark-hover:text-gray-300">
        ...
        <a href="https://twitter.com/goleaply" class="ml-6 text-gray-400 hover:text-gray-500 dark-hover:text-gray-300">
        ...
        <a href="https://github.com/leaply" class="ml-6 text-gray-400 hover:text-gray-500 dark-hover:text-gray-300">
      ...
      <div class="mt-8">
        <p class="text-center text-base leading-6 text-gray-400">
          &copy; 2020 Leaply Corp. All rights reserved.
        </p>
      </div>
    </div>
  </div>
